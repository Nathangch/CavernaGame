...
GOOD_DEEDS = {
    ...
    "plantou 100 arvores": 5, "voluntario em cozinha": 4, "ensinou criancas carentes": 6,

    "limpou a praia local": 3, "economizou agua e energia": 2, "salvou uma vida": 10, "adotou uma crianca": 10,

    "cuidou de vizinho doente": 4, "doou roupas e brinquedos": 3, "denunciou um crime": 5,

    "ajudou a apagar incendio": 8, "sustentou a familia sozinho": 6, "perdoou uma divida": 5,

    "organizou evento beneficente": 6, "recicla todo o lixo": 2, "ajudou turista perdido": 2,

    "mediou uma briga feia": 4, "devolveu carteira achada": 5, "fez companhia para solitario": 3,

    "combateu injustica social": 7, "patrocinou bolsa de estudo": 8, "protegeu bioma local": 6

}

CRIMES = {

    "mentiu para os pais": 1, "roubou doce da crianca": 2, "jogou lixo na rua": 1,
    ...
    "falso testemunho": 7, "maus-tratos a idosos": 10, "sonegacao de impostos": 7,

    "fofoca destrutiva": 3, "dirigiu embriagado": 8, "ameaca de violencia": 6,

    "furto de loja": 5, "bullying na escola": 4, "quebrou promessa sagrada": 3,

    "trafico de influencias": 7, "negligencia criminosa": 8, "perturbacao do sossego": 2
...
class GameState:
    ...
    def __init__(self):
        ...
        self.victory_choice = None # REENCARNAR or PARAÍSO
...
def draw_main_menu(surface, gs, vs):
    ...
    draw_button(surface, start_btn, "COMECAR", vs.font_ui, GOLD_COLOR, hover=is_hover_start)
...
def draw(surface, gs, ins, vs):
    ...
    if gs.state == "STORY":
        ...
        narrative = [
            ...
            "Saudacoes, Juiz Celestial. O equilibrio entre o Eter e o Abismo esta em tuas maos.",

            "Cada alma que cruza este portal carrega o peso de seus atos terrenos.",

            "Julga com sabedoria: teu dever determinara quem merece a gloria ou o fogo.",

            "Falhar em teu julgamento selara também o teu proprio destino eterno."
        ...
        manual = [
            ...
            "Cada 50 pontos voce sobe de fase. O jogo termina na fase 20."
    ...
    if gs.state == "VICTORY_CHOICE":
        ...
        narrative = "Sua jornada como juiz termina aqui. Voce provou sua retidao e justica. Diante de sua sabedoria, os portoes se abrem. Qual destino desejas para si mesmo?"
    ...
    if card and gs.state == "PLAYING":
        ...
        draw_shadowed_text(surface, "BOAS ACÕES:", vs.font_category, DEED_GREEN, (ct.left, y))
    ...
    if gs.state == "GAMEOVER":
        ...
        draw_text_centered_shadow(surface, f"Voce falhou na fase {gs.level}. Destino: Inferno.", vs.font_content, (220,220,220), VIRTUAL_HEIGHT//2 - 20)
    ...
    if gs.state == "VICTORY":
        ...
        bg_col = (0,30,60,230) if gs.victory_choice == "PARAÍSO" else (10, 50, 10, 230)
        ...
        desc = "A vida te chama novamente para uma nova jornada." if gs.victory_choice == "REENCARNAR" else "Voce descansara na luz eterna por toda a eternidade."
    ...
    for event in pygame.event.get():
        ...
        if gs.state == "VICTORY_CHOICE":
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                elif btn_paraiso.collidepoint(mx, my): gs.victory_choice = "PARAÍSO"; gs.state = "VICTORY"
